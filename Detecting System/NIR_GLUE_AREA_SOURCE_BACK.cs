...
public class Processor
{
    ...
    public Processor()
    {
        ...
        parameter_set.Add("expected_holder_radius", 355);
    ...
    public System.String Query_Error_Code_Detail(int errorCode)
    {
        ...
        switch (errorCode)
        {
            ...
            case -1:
                ...
                break;
            case -2:
                errorDescript = "程序未能定位产品长方形区域";
                break;
            case -3:
                errorDescript = "程序未能找到holder(边缘黑圈)";
                break;
            case -4:
                errorDescript = "样品明显异常";
                break;
            case -998:
                errorDescript = "尚未载入或者建好模板";
                break;
            default:
    ...
    public int Process(HObject ho_srcImage, out HObject glue_region, out HObject spot_region, out Result result)
    {
        return Process_(1, ho_srcImage, out glue_region, out spot_region, out result);
    }
    public int Process(HObject ho_srcImage, out HObject glue_region, out Result result)
    {
        HObject dummy_region;
        return Process_(0, ho_srcImage, out glue_region, out dummy_region, out result);
    }
    ...
    private int Process_(int mode, HObject ho_srcImage_, out HObject glue_region, out HObject spot_region, out Result result)
    {
        result = new Result();
        ...
        HObject ho_all_fholdere_region1, ho_all_fholdere_region2;
        HObject ho_all_fholdere_region, ho_edgeAmp, ho_edgeDir;
        ...
        HObject ho_fholdere_region1, ho_fholdere_region2, ho_fholdere_region;
        HObject ho_glue_region_connected, ho_ignore_circle, ho_polar_image;
        HObject ho_poar_image_mean, ho_spot_region_polar, ho_spot_region;
        ...
        HTuple hv_percent90_grayVal = new HTuple(), hv_j = new HTuple();
        ...
        HOperatorSet.GenEmptyObj(out ho_all_fholdere_region1);
        HOperatorSet.GenEmptyObj(out ho_all_fholdere_region2);
        HOperatorSet.GenEmptyObj(out ho_all_fholdere_region);
        ...
        HOperatorSet.GenEmptyObj(out ho_fholdere_region1);
        HOperatorSet.GenEmptyObj(out ho_fholdere_region2);
        HOperatorSet.GenEmptyObj(out ho_fholdere_region);
        ...
        try
        {
                ...
                0))) != 0)
            {
                    ...
                    1))) != 0)
                {
                    ...
                    ho_all_fholdere_region1.Dispose();
                    ho_all_fholdere_region2.Dispose();
                    ho_all_fholdere_region.Dispose();
                    ho_edgeAmp.Dispose();
                    ho_edgeDir.Dispose();
                    ...
                    ho_fholdere_region1.Dispose();
                    ho_fholdere_region2.Dispose();
                    ho_fholdere_region.Dispose();
            ...
            if ((int)(new HTuple((new HTuple(hv_rect_param.TupleLength())).TupleEqual(0))) != 0)
            {
                ho_srcImage.Dispose();
                ho_target_rect.Dispose();
                ho_srcImage_reduced.Dispose();
            ...
            hv_target_rect_row = hv_rect_param.TupleSelect(0);
            hv_target_rect_col = hv_rect_param.TupleSelect(1);
            hv_target_rect_phi = hv_rect_param.TupleSelect(2);
            hv_target_rect_length1 = hv_rect_param.TupleSelect(3);
            hv_target_rect_length2 = hv_rect_param.TupleSelect(4);
            ho_target_rect.Dispose();
            HOperatorSet.GenRectangle2(out ho_target_rect, hv_rect_param.TupleSelect(0),
                hv_rect_param.TupleSelect(1), hv_rect_param.TupleSelect(2), hv_rect_param.TupleSelect(
                3), hv_rect_param.TupleSelect(4));
            ho_srcImage_reduced.Dispose();
            ...
            for (hv_i = 0; (int)hv_i <= (int)((new HTuple(hv_orientation.TupleLength())) - 1); hv_i = (int)hv_i + 1)
            {
                ...
                hv_col_offset = hv_expected_holder_radius1 * (((hv_orientation.TupleSelect(
                    hv_i))).TupleCos());
                HOperatorSet.GenMeasureRectangle2((hv_rect_param.TupleSelect(0)) + hv_row_offset,
                    (hv_rect_param.TupleSelect(1)) + hv_col_offset, hv_orientation.TupleSelect(
            ...
            for (hv_i = 0; (int)hv_i <= 3; hv_i = (int)hv_i + 1)
            {
                ...
                {
                    ho_four_rect_holder.Dispose();
                    HOperatorSet.Intersection(ho_four_rects_, ho_holder_region, out ho_four_rect_holder
                        );
                    {
                        HObject ExpTmpOutVar_0;
                        HOperatorSet.Difference(ho_four_rects_, ho_holder_region, out ExpTmpOutVar_0
                            );
                        ho_four_rects_.Dispose();
                        ho_four_rects_ = ExpTmpOutVar_0;
                    }
                }
                ho_srcImage_histogram_.Dispose();
                HOperatorSet.ReduceDomain(ho_srcImage_reduced, ho_four_rects_, out ho_srcImage_histogram_
                    );
                //(2)
                HOperatorSet.GrayHisto(ho_four_rects_, ho_srcImage_histogram_, out hv_AbsoluteHisto,
                    out hv_RelativeHisto);
                ...
                if ((int)(new HTuple(((((hv_glue_thresh - hv_glue_thresh_all)).TupleAbs())).TupleGreater(
                    10))) != 0)
                {
                    hv_glue_thresh = hv_glue_thresh_all.Clone();
                }
                ho_srcImage_histogram_inverted.Dispose();
                HOperatorSet.InvertImage(ho_srcImage_histogram_, out ho_srcImage_histogram_inverted
                    );
                ho_glue_region_.Dispose();
                if (hv_thresh_offset.D > 0)
                {
                    HOperatorSet.HysteresisThreshold(ho_srcImage_histogram_inverted, out ho_glue_region_,
                        255 - hv_glue_thresh, (255 - hv_glue_thresh) + hv_thresh_offset, 5);
                }
                else
                {
                    HOperatorSet.Threshold(ho_srcImage_histogram_, out ho_glue_region_, 0, hv_glue_thresh - hv_thresh_offset);
                }
                {
                    HObject ExpTmpOutVar_0;
                ...
                for (hv_j = 1; (int)hv_j <= 255; hv_j = (int)hv_j + 1)
                {
                    ...
                    if ((int)(new HTuple(((hv_RelativeHisto.TupleSelect(hv_j))).TupleGreater(
                        0.90))) != 0)
                    {
                        hv_percent90_grayVal = hv_j.Clone();
                        break;
                    }
                }
                ho_leakage_region_.Dispose();
                HOperatorSet.Threshold(ho_test_leakage_image, out ho_leakage_region_, hv_percent90_grayVal + hv_leakage_gray_offset,
                    255);
                {
                    HObject ExpTmpOutVar_0;
            ...
            {
                ho_holder_image.Dispose();
                HOperatorSet.ReduceDomain(ho_srcImage_reduced, ho_holder_region, out ho_holder_image
                    );
                ho_leakage_region.Dispose();
                HOperatorSet.Threshold(ho_holder_image, out ho_leakage_region, hv_glue_thresh_all + hv_leakage_gray_offset,
                    255);
            }
            ...
            if ((int)(new HTuple(hv_leakage_region_count.TupleNotEqual(0))) != 0)
            {
                ...
                Get_Region_Angle_Range(ho_leakage_region, ho_srcImage, hv_sample_center_row,
                    hv_sample_center_col, hv_min_arc_length, hv_radial_width_thresh, out hv_leak_pass_mask);
                ho_leakage_region_pass.Dispose();
            ...
            //---Purpose---
            //*Avoid the fholdere effect which will cause the program to not include the border region into glue region**
            //---Implementation----
            ...
            HOperatorSet.GenRegionPolygonFilled(out ho_right_border_region, hv_right_border_row,
                hv_right_border_col);
            ho_all_fholdere_region1.Dispose();
            HOperatorSet.Union2(ho_upper_border_region, ho_lower_border_region, out ho_all_fholdere_region1
                );
            ho_all_fholdere_region2.Dispose();
            HOperatorSet.Union2(ho_left_border_region, ho_right_border_region, out ho_all_fholdere_region2
                );
            ho_all_fholdere_region.Dispose();
            HOperatorSet.Union2(ho_all_fholdere_region1, ho_all_fholdere_region2, out ho_all_fholdere_region
                );
            ...
            HOperatorSet.Union2(ho_left_border_region_filled, ho_right_border_region_filled,
                out ho_fholdere_region1);
            ho_fholdere_region2.Dispose();
            HOperatorSet.Union2(ho_upper_border_region_filled, ho_lower_border_region_filled,
                out ho_fholdere_region2);
            ho_fholdere_region.Dispose();
            HOperatorSet.Union2(ho_fholdere_region1, ho_fholdere_region2, out ho_fholdere_region
                );
            ...
            //Region not counted as glue because of fholdere effect is now include
            {
                HObject ExpTmpOutVar_0;
                HOperatorSet.Union2(ho_fholdere_region, ho_glue_region, out ExpTmpOutVar_0);
                ho_glue_region.Dispose();
                ho_glue_region = ExpTmpOutVar_0;
            }
            ...
            if (mode == 1)
            {
                ...
                hv_polar_height = 128;
                ho_polar_image.Dispose();
                HOperatorSet.PolarTransImageExt(ho_srcImage_reduced, out ho_polar_image, hv_sample_center_row,
                    hv_sample_center_col, 0, (new HTuple(360)).TupleRad(), 0, hv_sample_radius,
                    hv_polar_width, hv_polar_height, "nearest_neighbor");
                ho_poar_image_mean.Dispose();
                HOperatorSet.MeanImage(ho_polar_image, out ho_poar_image_mean, 1024, 3);
                ho_spot_region_polar.Dispose();
                HOperatorSet.DynThreshold(ho_polar_image, ho_poar_image_mean, out ho_spot_region_polar,
                    hv_spot_threshold, "light");
                ho_spot_region.Dispose();
                HOperatorSet.PolarTransRegionInv(ho_spot_region_polar, out ho_spot_region,
                    hv_sample_center_row, hv_sample_center_col, 0, (new HTuple(360)).TupleRad()
                    , 0, hv_sample_radius, hv_polar_width, hv_polar_height, hv_srcWidth, hv_srcHeight,
                    "nearest_neighbor");
            ...
            HOperatorSet.DistancePr(ho_glue_region, hv_sample_center_row, hv_sample_center_col, out hv_minDistance, out hv_maxDistance);
            result.
                minDistance = hv_minDistance.D * 2.35 * 2 * 1000 / (hv_target_rect_length1 + hv_target_rect_length2 + 0.0);
            //---Purpose---
            ...
            //<<<<<<<<<<<<<<Parameter setting<<<<<<<<<<<<<<<<<
            ho_yellow_region.Dispose();
            HOperatorSet.GenCircle(out ho_yellow_region, hv_sample_center_row, hv_sample_center_col,
                hv_yellow_red_radius);
       

            ho_red_region.Dispose();
            HOperatorSet.GenCircle(out ho_red_region, hv_sample_center_row, hv_sample_center_col,
                hv_red_cyan_radius);
          ...
          
            {
                ...
                HOperatorSet.GenCircle(out ho_yellow_inner_region, hv_sample_center_row, hv_sample_center_col, hv_yellow_radius);
                HObject ExpTmpOutVar_0;
